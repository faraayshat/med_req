      ...
      <main className="flex-1 min-w-0 flex flex-col h-screen overflow-hidden">
        ...
        <header className="h-16 bg-white/80 backdrop-blur-xl border-b border-slate-200 px-6 xl:px-10 flex items-center justify-between shrink-0 sticky top-0 z-50">
          ...
          <div className="flex items-center gap-3 xl:gap-5">
            ...
            <button className="relative p-2 rounded-full bg-white border border-slate-200 hover:border-rose-100 hover:bg-rose-50 text-slate-400 hover:text-rose-600 transition-all">
              <Bell className="w-4 h-4" />
              <span className="absolute top-1.5 right-1.5 w-1.5 h-1.5 bg-rose-600 rounded-full border border-white shadow-sm" />
            </button>
